...
nástroje, který je součástí práce.
    ...
    \end{figure}
        ...
        Při přesouvání nastává událost \texttt{dragmove}. K té také lze naslouchat. Naivní možnost by byla přesouvat na ostatních bannerech stejný tvar o počet pixelů,
